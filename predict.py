...
pred_cfg = dict(
    ...
    # ---------- 深度卷积神经网络模型的超参数 ----------
    model_path="./logs/deeplabv3plus_fusion/06_deeplabv3plus_backbone_bs16_500epoch_adam_multi_branches_aux_branches_RepMobileNetV3_Small/best_epoch_weights.pth",
